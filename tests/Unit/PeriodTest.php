...
{
    public function testFromWhenValidRangeThenExposesBoundaries(): void
    {
    ...
    public function testContainsWhenInstantAtEndThenReturnsFalse(): void
    {
    ...
    public function testContainsWhenInstantAtStartThenReturnsTrue(): void
    {
        /** @Given a Period [10:00, 11:00) */
        $period = Period::from(
            from: Instant::fromString(value: '2026-02-17T10:00:00+00:00'),
    ...
    public function testContainsWhenInstantInMiddleThenReturnsTrue(): void
    {
        /** @Given a Period [10:00, 11:00) */
        $period = Period::from(
            from: Instant::fromString(value: '2026-02-17T10:00:00+00:00'),
    ...
    public function testContainsWhenInstantAfterEndThenReturnsFalse(): void
    {
        /** @Given a Period [10:00, 11:00) */
        $period = Period::from(
            from: Instant::fromString(value: '2026-02-17T10:00:00+00:00'),
    ...
    public function testFromWhenStartEqualsEndThenThrowsInvalidPeriod(): void
    {
    ...
    public function testOverlapsWithWhenPartialOverlapThenReturnsTrue(): void
    {
        /** @Given a Period [10:00, 11:00) */
        $periodA = Period::from(
            from: Instant::fromString(value: '2026-02-17T10:00:00+00:00'),
    ...
    public function testContainsWhenInstantBeforeStartThenReturnsFalse(): void
    {
        /** @Given a Period [10:00, 11:00) */
        $period = Period::from(
            from: Instant::fromString(value: '2026-02-17T10:00:00+00:00'),
    ...
    public function testFromWhenStartIsAfterEndThenThrowsInvalidPeriod(): void
    {
    ...
    public function testOverlapsWithWhenAdjacentPeriodsThenReturnsFalse(): void
    {
        /** @Given a Period [10:00, 11:00) */
        $periodA = Period::from(
            from: Instant::fromString(value: '2026-02-17T10:00:00+00:00'),
    ...
    public function testOverlapsWithWhenDisjointPeriodsThenReturnsFalse(): void
    {
    ...
    public function testOverlapsWithWhenIdenticalPeriodsThenReturnsTrue(): void
    {
        /** @Given a Period [10:00, 11:00) */
        $periodA = Period::from(
            from: Instant::fromString(value: '2026-02-17T10:00:00+00:00'),
    ...
    public function testStartingAtWhenValidDurationThenExposesBoundaries(): void
    {
    ...
    public function testOverlapsWithWhenOneContainsAnotherThenReturnsTrue(): void
    {
        ...
        /** @When checking if the outer period overlaps the inner */
        $overlaps = $outer->overlapsWith(other: $inner);
    ...
    public function testOverlapsWithWhenOverlappingPeriodsThenIsSymmetric(): void
    {
        /** @Given a Period [10:00, 11:00) */
        $periodA = Period::from(
            from: Instant::fromString(value: '2026-02-17T10:00:00+00:00'),
    ...
    public function testDurationWhenSpansOneHourThenReturnsExpectedSeconds(): void
    {
    ...
    public function testStartingAtWhenDurationIsZeroThenThrowsInvalidPeriod(): void
    {
        /** @Given a start Instant */
        $from = Instant::fromString(value: '2026-02-17T10:00:00+00:00');
    ...
    public function testDurationWhenCreatedFromAndStartingAtThenIsConsistent(): void
    {
        /** @Given a start Instant */
        $from = Instant::fromString(value: '2026-02-17T10:00:00+00:00');
        ...
        /** @When getting the Duration of the Period created via from() */
        $duration = $periodFromFrom->duration();

        /** @Then both should have the same Duration */
        self::assertSame($duration->toSeconds(), $periodFromStartingAt->duration()->toSeconds());
    }

    public function testOverlapsWithWhenNonOverlappingPeriodsThenIsSymmetric(): void
    {
        /** @Given a Period [08:00, 09:00) */
    ...
    public function testContainsWhenSingleInstantThenIsConsistentWithOverlaps(): void
    {
        /** @Given a Period [10:00, 11:00) */
        $period = Period::from(
            from: Instant::fromString(value: '2026-02-17T10:00:00+00:00'),
    ...
    public function testDurationWhenPeriodOfThirtyMinutesThenConvertsToMinutes(): void
    {
    ...
    public function testStartingAtWhenDurationCrossesDayBoundaryThenEndsOnNextDay(): void
    {
    ...
    public function testDurationWhenPeriodCreatedFromStartingAtThenMatchesInputDuration(): void
    {
